...
class P006_ZigZagConversion : public ::testing::Test {
protected:
  p006::Solution sol;
};

TEST_F(P006_ZigZagConversion, EmptyStr) {
...
TEST_F(P006_ZigZagConversion, Generic0) {
...
TEST_F(P006_ZigZagConversion, LeetCode2) {
